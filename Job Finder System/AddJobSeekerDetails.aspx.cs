...
namespace Job_Finder_System.JobSeeker
{
    public partial class AddJobSeekerDetails : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
                ...
                using (SqlCommand cmd = new SqlCommand("INSERT INTO JobSeekerDetails values (@ContactNo, @Address, @Image, @State, @Username,@Skills)", con))
                {
