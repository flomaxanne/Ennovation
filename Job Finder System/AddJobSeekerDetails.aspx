<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddJobSeekerDetails.aspx.cs" Inherits="Job_Finder_System.JobSeeker.AddJobSeekerDetails" %>
            ...
            <div class="panel panel-info">
                ...
                <div style="padding-top: 30px;" class="panel-body">
                    ...
                    <form id="form1" runat="server">
                        ...
                        <div class="form-group">
                            <asp:Label class="col-sm-3 control-label" runat="server" Text="Skills"  />
                            <div class="col-sm-9">
                                <asp:TextBox class="form-control" ID="txtskills"  runat="server" placeholder="Please enter skills" />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtAddress" ErrorMessage="Enter Address" ForeColor="Red" Width="250px"></asp:RequiredFieldValidator>
                            </div>
                        </div>
