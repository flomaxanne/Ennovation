...
namespace Job_Finder_System.Admin
{
    public partial class Admin : System.Web.UI.Page
    {
        ...
        private DataTable GetPosterRecords()
        {
            SqlConnection conn = new SqlConnection(conString);
            conn.Open();
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = conn;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "Select * from JobPosterDetails";
        ...
        protected void DeletePoster(object sender, EventArgs e)
        {
            LinkButton lnkRemove = (LinkButton)sender;
            SqlConnection con = new SqlConnection(conString);
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "delete from JobPosterDetails where PosterID=@PosterID";
            cmd.Parameters.Add("@ID", SqlDbType.VarChar).Value = lnkRemove.CommandArgument;
            PosterGridView.DataSource = GetData(cmd);
            BindGrid();
        }
