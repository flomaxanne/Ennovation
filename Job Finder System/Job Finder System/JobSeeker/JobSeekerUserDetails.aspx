<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="JobSeekerUserDetails.aspx.cs" Inherits="Job_Finder_System.JobSeekerUserDetails" %>
                    ...
                    <div style="display: none" id="changedetails-alert" class="alert alert-danger col-sm-12"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="fuPosterImage" ErrorMessage="Enter Image" ForeColor="Red" Width="250px"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtContactNumber" ErrorMessage="Enter Current Contact Number" 
                                ValidationExpression="[0-9]{11}" ForeColor="Red" Width="250px"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <asp:TextBox class="form-control" ID="txtContactNumber"  runat="server" />
