<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="JobPosterUserDetails.aspx.cs" Inherits="Job_Finder_System.JobPosterUserDetails" %>
                    ...
                    <div style="display: none" id="changedetails-alert" class="alert alert-danger col-sm-12"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtUsername" ErrorMessage="Enter Current Contact Number" 
